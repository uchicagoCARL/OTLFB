<%@ Control Language="vb" AutoEventWireup="false" Inherits="calendar.theCalendarControl" CodeFile="theCalendarControl.ascx.vb" %>
<style type="text/css">
...
<asp:panel id="PanelCalendar" Height="375px" Width="650px" runat="server" 
    HorizontalAlign="Center">
		<asp:Label ID="Label1" runat="server" CssClass="HomeHead" 
            Text="Drinking and Smoking Calendar" Width="550px"></asp:Label>
        <br />
		<asp:Table id="TableCalendar" HorizontalAlign="Center" runat="server" Width="550px" Height="198px" BorderColor="Maroon" BorderWidth="1px" CellSpacing="0" CellPadding="0" BorderStyle="Solid" Font-Name="Arial" Font-Size="11" GridLines="Both">
