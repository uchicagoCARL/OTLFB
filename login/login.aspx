<%@ Page Language="vb" AutoEventWireup="false" Inherits="calendar.login" CodeFile="login.aspx.vb" %>

<%@ Register TagPrefix="eCommerce" TagName="Menu" Src="~/Menu.ascx" %>
<%@ Register TagPrefix="eCommerce" TagName="header" Src="~/header.ascx" %>
<%@ Register TagPrefix="eCommerce" TagName="Content" Src="login.ascx" %>
<html>
<head>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top">
                    ...
                    <td width="80%" id="Content">
                        <p>
                            <eCommerce:Content runat="server" ID="Content1" />
                        </p>
                    </td>
                </tr>
            </table>
